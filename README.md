...
[![Feature
Explorer](https://img.shields.io/badge/✨-Feature%20Explorer-6D28D9)](https://asalavaty.com/widgets/CelliVerse)
...
For complete package documentation, examples, and interactive resources,
see:

- [CelliVerse Feature
  Explorer](https://asalavaty.com/widgets/CelliVerse)
- [CelliVerse GitHub
...
Three complementary resources are available for exploring CelliVerse
without first working through the full package documentation.

### Feature Explorer

The **[CelliVerse Feature
Explorer](https://asalavaty.com/widgets/CelliVerse)** provides a focused
interactive way to browse the features and capabilities of the
CelliVerse R package and identify workflows relevant to a particular
analysis.
...
A lightweight browser-based demonstration of selected ClustoCell outputs
is available through Hugging Face Spaces. The demo uses precomputed
PBMC3K results and allows users to explore UMAP visualizations,
ClustoCell clusters and sub-clusters, and marker tables without
installing the package locally.

<p align="center">

<a href="https://huggingface.co/spaces/asalavaty/celliverse" target="_blank" rel="noopener noreferrer">
<img src="https://img.shields.io/badge/🤗-Open%20ClustoCell%20Demo-FFD21E?style=for-the-badge" alt="Open ClustoCell Demo"/>
</a>
</p>
...
| Resource | Location |
|:---|:---|
| CelliVerse Feature Explorer | [asalavaty.com/widgets/CelliVerse](https://asalavaty.com/widgets/CelliVerse) |
...
| Reproducibility repository | [github.com/asalavaty/CelliVerse-Project](https://github.com/asalavaty/CelliVerse-Project) |
